...
export function StepIndicator({ currentStep, steps }: StepIndicatorProps) {
  return (
    <div className="flex items-center justify-center gap-1 sm:gap-2 overflow-x-auto px-1">
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span
                className={cn(
                  "hidden sm:block text-[10px] sm:text-xs whitespace-nowrap",
                  isCurrent
