...
function SidebarProvider({
  ...
  // Auto-collapse sidebar on tablet (768px - 1023px).
  // On mount and whenever isTablet changes, collapse the sidebar.
  React.useEffect(() => {
    if (isTablet) {
      setOpen(false);
    }
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'hover:border-primary hover:scale-105 hover:shadow-sm',
        'active:scale-95',
