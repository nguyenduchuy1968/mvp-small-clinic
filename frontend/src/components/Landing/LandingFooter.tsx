          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm text-blue-200">{clinicConfig.phone}</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 shrink-0 text-teal-400" />
                <span className="text-sm text-blue-200">{clinicConfig.email}</span>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-3">
                ...
                <div className="flex flex-1 justify-between text-sm">
                  ...
                  <span className="text-white font-medium">{clinicConfig.workingHours.weekday}</span>
                </div>
              </li>
              <li className="flex items-center gap-3">
                <Clock className="h-4 w-4 shrink-0 text-teal-400" />
                <div className="flex flex-1 justify-between text-sm">
                  ...
                  <span className="text-white font-medium">{clinicConfig.workingHours.saturday}</span>
                </div>
              </li>
              <li className="flex items-center gap-3">
                <Clock className="h-4 w-4 shrink-0 text-teal-400" />
                <div className="flex flex-1 justify-between text-sm">
                  ...
                  <span className="text-white font-medium">{clinicConfig.workingHours.sunday}</span>
                </div>
              </li>
            </ul>
          </div>
